...
document.getElementById('comparisonResult').innerHTML = <p>Investment A after ${y} years: $${aTotal.toFixed(2)} Investment B after ${y} years: $${bTotal.toFixed(2)} <strong>Better return: ${winner}</strong></p>; 
});